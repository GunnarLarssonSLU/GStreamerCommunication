/****************************************************************************
** Meta object code from reading C++ file 'gstreamerworker.h'
**
...
#error "The header file 'gstreamerworker.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GStreamerWorker_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GStreamerWorker_t qt_meta_stringdata_GStreamerWorker = {
    {
QT_MOC_LITERAL(0, 0, 15) // "GStreamerWorker"
...
QT_INIT_METAOBJECT const QMetaObject GStreamerWorker::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_GStreamerWorker.data,
